    ...
    */
    ...
    if (eventData) {
        if (eventData.data) {
            ...
            updatedPrice = updatedPrice.toFixed(2).replace('.', ',');
            ...
            if (counter == 0 || counter % 6 == 0) {
                ...
                prices.push(JSON.parse(event.data).data[0].p);
            ...
            //update the UI
            $(".price").text(updatedPrice); //price - big display
            $("#price").val(updatedPrice); //price - input hidden
        }
    }
});
